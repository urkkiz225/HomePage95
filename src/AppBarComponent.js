...
const AppBarComponent = () => {
  ...
  const TheTrollingArrayWithABigTee = ['This is taking a bit longer than usual...', 'Almost done...', 'Fetching website data...', 'Fetching results...', 
    ...
    'Fixing the flux capacitor (mark VIII)...', 'Taking a nap...', 'Playing Black Sabbath...', 'Revisiting 2013...', 'Wut!! LOLZ XD check out this nyan cat gif!!', 'https://tenor.com/view/nyan-cat.gif', 
    'Where were we again? -', '- searching... or something.', '*yawn*', 'heavily thinking about the results...', 
    'fetching... something... probably', 'Having an existential code snippet crisis...', 'Turning it on and off again...', 'Rebooting...', 
