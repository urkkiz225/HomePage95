    ...
    <ThemeProvider theme={redWine}>
      <span className="ms-sans-serif">
        ...
        <div style={{ paddingTop: '130px' }}>
          <h1 style={{ position: 'relative', top: '0px', minHeight: '3vh', color: 'white', transform: `scale(${1.1})`, textWrap: 'pretty', textAlign: 'center', paddingLeft: '50px', paddingRight: '50px' }}>An evil <a href="/HomePage95/#/main" style={{ color: 'red' }}>gnome</a> seems to have eaten all the content on this page. {isMobile && ("also there are some problems on mobile right now...")}</h1>
